...
//			return(nodoPrimero == null)?true:false;
		...
		public void eliminarDuplicado() {
		    NodoDoble<T> p = nodoPrimero;
		    while(p!=null) {
		    	NodoDoble q = p;
		        while(q.getSiguienteNodo() != null) {
		            if(p.getValorNodo() == q.getSiguienteNodo().getValorNodo()) {
		                q.setSiguienteNodo(q.getSiguienteNodo().getSiguienteNodo());
		            } else {
		                q = q.getSiguienteNodo();
		            }
		        }
		        p = p.getSiguienteNodo();
		    }
		}
		...
		public void setTamanio(int tamaio) {
			this.tamanio = tamaio;
		}
